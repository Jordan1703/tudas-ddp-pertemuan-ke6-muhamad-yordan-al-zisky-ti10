...
#menggunakan loop while untuk mencetak bilngan ganjil sampai bertemu dengan 553
while index<len(numbers):
    if numbers[index]%2 != 0: #cek apakah bilangan ganjil
        print (numbers[index], end=" ")
    if numbers[index] == 553: #hentikan peerulangan jika sudah mencapai 553
        break
    index +=1
print(" ")
...
#tugas no 2
print(" ")
print("2.buat lah output dari menggunakan bahasa pemograman phyton dengan :1+3+5+9+11+13+15+17+19= ...")
print(" ")
...
jumlah_baris = int(input("masukan julah baris: "))
